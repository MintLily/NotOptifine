...
namespace NotOptifine
{
    ...
    internal class Main : MelonMod
    {
        ...
        public override void OnApplicationStart()
        {
            ...
            MelonLogger.Msg(
                $"[Ctrl + ScrollWheel] -> {(disableCTRLZoom.Value ? "Function Disabled" : "Increase or decrease field of view")}");
        ...
        public override void OnUpdate() =>
            LoopEveryFrame_CuzThatsWhatOnUpdateMeans_ForVRChat_NotMinecraft_ThisIsNotOptifine(); // Sorry, just wanted funny name
        ...
        private void LoopEveryFrame_CuzThatsWhatOnUpdateMeans_ForVRChat_NotMinecraft_ThisIsNotOptifine()
        {
            ...
            {
                if ((Utils.GetKeyUp(KeyCode.LeftControl) || Utils.GetKeyUp(KeyCode.RightControl)) && !isZoomed &&
                    lastFOV != FOV.Value)
                {
